...
export PYTHONPATH=/home1/l/lingxiao/xiao/adj-relation
...
# run my scripts
python $HOME/xiao/adj-relation/experiments/regression/demos/run_model_has_ngram_data.py
